 ...
 * النسخة المحدثة (3.2) - الختمة العائلية بأسماء السور وتصميم احترافي
 */ 
...
// 🌟 قاعدة بيانات أسماء السور والأجزاء للختمة
...
function renderPortionsGrid(room) {
    ...
    for (let i = 1; i <= totalItems; i++) {
        ...
        // رسم حصتي باللون الأحمر والأخضر
    ...
    // رسم بطاقات المشتركين مع المربعات الأنيقة (Chips)
