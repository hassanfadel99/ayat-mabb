 ...
 * متضمن: القوائم، الستوريات (تيك توك Auto-play)، التحميل، والمشاركة المتوافقة مع الجسر البرمجي AndroidBridge.
 */
...
/* ==========================================
   نظام الستوريات مع ميزة التشغيل التلقائي
   ========================================== */
function setupStoriesListener() {
  ...
  database.ref('stories').on('value', (snapshot) => {
    ...
    setTimeout(setupAutoPlayObserver, 1000);
  });
}
...
/* ==========================================
   وظيفة مشاركة التطبيق (المدعومة بالجسر البرمجي)
   ========================================== */
function shareApp() {
  triggerHaptic();
  ...
  if (typeof AndroidBridge !== "undefined") {
    ...
    navigator.share({ title: 'تطبيق آيات', text: shareText }).catch(console.error);
  } else {
...
/* ==========================================
   ميزة التحميل المباشر (المدعومة بالجسر البرمجي)
   ========================================== */
