 ...
 * النسخة المحدثة والنهائية - استعادة كود التحديث الأصلي الناجح + القبلة والختمة
 */ 

// 🌟 تم إرجاع الكود الأصلي الخاص بك كما كان بالضبط 🌟
...
// 🌟 دالة التحديثات الأصلية الخاصة بك (بدون أي تحريف مني) 🌟
...
// ==========================================
// باقي الأكواد واللغات
// ==========================================

// 🌟 قمت بإرجاع اللغات الخاصة بك بالكامل 🌟
const i18n = { 
  ar: { 
    ...
    layout_desc: "5 أشكال احترافية", copy: "نسخ النص", close: "إغلاق", share: "مشاركة التطبيق", stories: "ستوريات قرآنية", stories_desc: "تلاوات قصيرة"
  }, 
  en: { 
    ...
    family_khatma: "Family Khatma", family_khatma_desc: "Shared Khatma", qibla: "Qibla", qibla_desc: "Accurate Compass",
  ...
  ku: { 
    ...
    family_khatma: "خەتمەی خێزانی", family_khatma_desc: "خەتمەی هاوبەش", qibla: "ڕووگە", qibla_desc: "بوصلەی ڕووگە",
  ...
  fa: { 
    ...
    family_khatma: "ختم خانواده", family_khatma_desc: "ختم مشترک", qibla: "قبله نما", qibla_desc: "قطب نمای دقیق",
...
// ==========================================
// 🌟 نظام الختمة العائلية (مع الإشعارات اللحظية) 🌟
// ==========================================
...
// 🌟 تشغيل الدوال عند فتح التطبيق (بما فيها الفحص الذي نسيته) 🌟
window.addEventListener("DOMContentLoaded", () => { 
    ...
    try { checkForUpdates(); } catch (e) {} // 🌟 الفحص يعمل الآن 🌟
