 ...
 * النسخة المحدثة (1.6) - أزرار مخصصة (فجر، ظهر، مغرب) وإشعارات خلفية + الختمة العائلية والقبلة
 */
...
function checkForUpdates() {
  // هذا هو الكود الأصلي الذي كان يعمل!
  ...
  if (dynamicUpdateUrl) {
    try {
      if (
        ...
        typeof window.AndroidBridge.openUpdateLink === "function"
      ) {
...
const i18n = {
  ar: {
    ...
    prayer: "الصلاة",
    asma_hero_desc:
      "انقر على أي اسم لتتعرف على معناه وموضع ذكره في القرآن الكريم.",
  ...
  en: {
    ...
    prayer: "Prayer",
    asma_hero_desc:
      "Tap on any name to learn its meaning and mention in the Quran.",
  ...
  ku: {
    ...
    prayer: "نوێژ",
    asma_hero_desc:
      "پەنجە بنێ بە هەر ناوێکدا بۆ زانینی مانا و شوێنی لە قورئاندا.",
  ...
  fa: {
    ...
    travel: "سفر",
    prayer: "نماز",
    asma_hero_desc: "برای شناخت معنی و محل ذکر در قرآن روی هر نام کلیک کنید.",
...
const fullAzkarDatabase = {
  sabah: [
    ...
    {
      text: "أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ لَا إِلَهَ إِلَّا اللهُ...",
      count: 1,
    },
    {
  ...
  maseh: [
    ...
    {
      text: "أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ لَا إِلَهَ إِلَّا اللهُ...",
      count: 1,
    },
  ],
  travel: [
    {
      text: "اللهُ أَكْبَر، اللهُ أَكْبَر، اللهُ أَكْبَر، سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقْرِنِينَ...",
      count: 1,
    },
  ],
  prayer: [
    {
      text: "أَسْتَغْفِرُ اللَّهَ (ثَلَاثاً). اللَّهُمَّ أَنْتَ السَّلَامُ وَمِنْكَ السَّلَامُ...",
      count: 1,
    },
    {
...
window.showSection = function (id) {
  ...
  // تفعيل تبويب הختمة الحالي عند الفتح
...
window.shareApp = function () {
  ...
  if (
    typeof AndroidBridge !== "undefined" &&
    typeof AndroidBridge.shareApp === "function"
  ) {
...
window.directDownloadVideo = async function (event, url) {
  ...
  if (
    typeof AndroidBridge !== "undefined" &&
    typeof AndroidBridge.downloadVideo === "function"
  ) {
...
window.cancelDownload = function () {
  ...
  if (
    typeof AndroidBridge !== "undefined" &&
    typeof AndroidBridge.cancelDownloadVideo === "function"
  ) {
...
// ==========================================
// 🌟 دوال نافذة الـ GPS والقبلة المحدثة
// ==========================================
...
function openGPSSetting() {
    ...
    try {
        if (window.AndroidBridge && typeof window.AndroidBridge.openLocationSettings === "function") {
...
function checkCurrentRoom() {
    ...
    fkRoomListener = database.ref('family_khatmas/' + currentFkRoomId).on('value', snapshot => {
        ...
        try {
            if (window.AndroidBridge && typeof window.AndroidBridge.sendLocalNotification === "function") {
                if (!isFkInitialLoad) {
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  try {
    checkForUpdates(); // 🌟 الاستدعاء موجود هنا وسيعمل بنجاح
  } catch (e) {}
  try {
    fetchPrayerTimes();
    initPrayerSettings();
  ...
  try {
      if (currentFkRoomId) { isFkInitialLoad = true; checkCurrentRoom(); }
  } catch (e) {}
});
