/** 
 * تطبيق آيات - الملف البرمجي الشامل (النسخة 3.5 المحدثة)
 */ 
...
// ==========================================
// 9. مشغل القرآن الكريم (مع التزامن)
// ==========================================
...
// ==========================================
// 10. مكتبة الأدعية والمشغل الكامل (مع التزامن)
// ==========================================
        ...
        if (stat.total > 0) { 
            listAll.innerHTML += ` 
                <div class="participant-progress-card"> 
                    ...
                    <div style="font-size: 0.85rem; font-weight: bold; color: var(--text); opacity: 0.8; margin-bottom: 12px;"> الحصص المخصصة: </div> 
                    <div class="pp-portions-container"> ${chipsHtml} </div> 
                </div> 
            `; 
        } 
    }); 
