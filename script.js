...
// 🌟 تفريغ الذاكرة (Memory Flush) لمنع التعليق
window.renderStories = function (filterType) { 
  ...
  storiesToRender.forEach((vid, index) => { 
    ...
    // 🌟 حماية الذاكرة: نضع الرابط في data-src بدلاً من src لكي لا تُحمل كلها مرة واحدة
    ...
    const observer = new IntersectionObserver( (entries) => { 
      entries.forEach((entry) => { 
        ...
        if (entry.isIntersecting) { 
          // إذا ظهر الفيديو، نعطيه الرابط ليتحمل
          ...
          // 🌟 الحل النووي لمنع التعليق في الأجهزة الضعيفة: تفريغ الذاكرة تماماً
...
window.addEventListener("DOMContentLoaded", () => { try { loadPreferences(); } catch (e) {} try { renderAsmaMiniCards(); } catch (e) {} try { setupNameOfDay(); } catch (e) {} try { calculateHijriDate(); } catch (e) {} try { loadSurahs(); } catch (e) {} try { setupNotificationsListener(); } catch (e) {} try { setupStoriesListener(); } catch (e) {} try { checkForUpdates(); } catch (e) {} });
