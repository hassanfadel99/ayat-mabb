/** 
 * تطبيق آيات - الملف البرمجي الشامل (النسخة النهائية 3.6)
 * متوافق تماماً مع نظام أندرويد 14 والإشعارات الخلفية
 */ 

let APP_CURRENT_VERSION = 3.6; 
...
let currentPlayingType = null; // لمعرفة ما إذا كان يشتغل قرآن أو دعاء
...
const iraqCitiesCoords = { 
    Basra: { lat: 30.5081, lng: 47.7835 }, Baghdad: { lat: 33.3152, lng: 44.3661 }, Najaf: { lat: 31.9925, lng: 44.3258 }, Karbala: { lat: 32.616, lng: 44.0249 }, Babil: { lat: 32.4682, lng: 44.4009 }, "Dhi Qar": { lat: 31.058, lng: 46.2573 }, Maysan: { lat: 31.841, lng: 47.1432 }, "Al Qadisiyyah": { lat: 31.9868, lng: 44.9215 }, "Al Muthanna": { lat: 31.3129, lng: 45.2818 }, Wasit: { lat: 32.5065, lng: 45.8231 }, Diyala: { lat: 33.7431, lng: 44.6074 }, Kirkuk: { lat: 35.4674, lng: 44.3828 }, Mosul: { lat: 36.34, lng: 43.13 }, Erbil: { lat: 36.1901, lng: 44.0092 }, Sulaymaniyah: { lat: 35.55, lng: 45.4333 }, Saladin: { lat: 34.6071, lng: 43.6844 }, Anbar: { lat: 33.4215, lng: 43.3006 } 
}; 
...
if (quranAudioEl) { 
    ...
    quranAudioEl.onplay = () => { 
        ...
        // إخبار الأندرويد ليعرض زر Pause
...
window.downloadAudioFile = function(event, url, title) { 
    ...
    fetch(url).then(response => response.blob()).then(blob => { 
        ...
        a.style.display = "none"; a.href = blobUrl; a.download = title + ".mp3"; 
...
// ==========================================
// 11. الستوريات والختمة العائلية (كما هي بدون نقص)
// ==========================================
